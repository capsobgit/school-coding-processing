/**
  Hier werden sämtliche Linien für das Spiel definiert.
 */
public class Gitter
{  
  PShape[] gewinnLinien;
  ...
  private void initGewinnLinien()
  {
    ...
    gewinnLinien[4] = createShape(LINE, pos[12] - 50, pos[9], pos[14] -50, pos[15]);
    gewinnLinien[5] = createShape(LINE, pos[15] - 50, pos[9], pos[15] - 50, pos[15]);
    // diagonal
    gewinnLinien[6] = createShape(LINE, pos[0], pos[0], pos[15], pos[15]);
    gewinnLinien[7] = createShape(LINE, pos[15], pos[0], pos[0], pos[15]);
